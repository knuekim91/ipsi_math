...
<div class="fig"><img src="img/LIM-J04.png" width="1119" height="963"
  alt="함수 y=f(x)의 그래프. x가 −1보다 작을 때는 감소하는 직선이고, −1과 1 사이에서는 2에서 1로 내려오는 곡선이며, x가 1보다 크면 다시 직선이다. x=−1과 x=1 에서 뚫린 점과 채워진 점이 표시되어 있다."></div><p class="m">lim<sub>x→−1<sup>−</sup></sub> f(x) + lim<sub>x→1<sup>+</sup></sub> f(x)</p><p>의 값은?</p><div class="choices"><span>① −2</span><span>② −1</span><span>③ 0</span><span>④ 1</span><span>⑤ 2</span></div>
