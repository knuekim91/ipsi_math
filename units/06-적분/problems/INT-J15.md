...
<b><span class='m'>∫|g| = |∫g|</span> ⟺ g가 부호를 바꾸지 않는다.</b> 9월 확통 7번의 <span class='m'>Σ|a| = |Σa|</span>와 정확히 같은 구조다 — 절댓값을 밖으로 뺄 수 있는 것은 <b>부호가 한쪽으로 통일될 때뿐</b>이라는 하나의 원리. 그리고 <b>&lsquo;근이지만 부호가 안 바뀐다 = 짝수 위수의 근(중근)&rsquo;</b>은 다항함수 문제의 상비 도구다.
