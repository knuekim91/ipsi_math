...
<div class="modal" id="askmodal">
  <div class="sheet">
    <h2>아빠에게 보내기</h2>
    <div class="sub" id="asksub">아래 내용을 아빠에게 보내면, 아빠가 Claude에게 전달해 문항을 만들어 옵니다.</div>
    <button class="opt primary" id="asksend">카카오톡 · 메시지로 보내기<small>공유 창이 열리면 아빠를 고르세요</small></button>
